...
const CALLS = [
  { id: 1, fn: "invoice_matching", meta: "3.5 hrs/week", color: "#94a3b8", delay: 0 },
  { id: 2, fn: "contract_review", meta: "2.5 days", color: "#94a3b8", delay: 1.8 },
  { id: 3, fn: "support_ticket_triage", meta: "40 min/ticket", color: "#94a3b8", delay: 3.6 },
  { id: 4, fn: "expense_approval", meta: "€12/txn", color: "#94a3b8", delay: 5.4 },
];
  ...
  return (
    <div className="relative flex items-center h-10 select-none">
      ...
      <div className="w-16 shrink-0 flex items-center pl-2 overflow-hidden">
        ...
        >
          <span className="text-[10px] font-bold font-mono">manual</span>
        </motion.div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative w-full h-full bg-slate-950 overflow-hidden font-mono flex flex-col">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, transparent 45%, rgba(245,158,11,0.06) 100%)",
        }}
      />
      ...
      <div className="relative flex items-center justify-between px-4 py-2.5 border-b border-slate-800/50 bg-slate-900/50 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-slate-300 tracking-wide">
            CURRENT PROCESS · UNMEASURED
          </span>
        </div>
        <motion.span
          className="text-[11px] font-bold tracking-widest text-amber-400"
      ...
      <div className="relative px-4 pt-3 pb-1 shrink-0">
        <span className="text-[11px] text-slate-600">
          Manual processes running today, cost untracked:
        </span>
      </div>
      ...
      <motion.div
        ...
        className="relative mx-4 mb-3 px-3 py-2 border border-slate-700/40 bg-slate-800/20 flex items-center justify-between shrink-0"
      >
        <span className="text-[11px] text-slate-400">
          No baseline measured · 4 processes untracked
        </span>
